...
export default {
  ...
  "organizationName": "aptos-labs",
  "projectName": "aptos-core",
  "markdown": {
    "mermaid": true,
    "format": "mdx",
    "mdx1Compat": {
  ...
  "presets": [
    [
      "@docusaurus/preset-classic",
      {
        "docs": {
          "routeBasePath": "/",
          "sidebarPath": "/Users/007/DEV/Aptos/Aptos-document/locale/Aptos-operating-handbook/apps/docusaurus/src/components/sidebars.ts",
        ...
        "blog": false,
        "theme": {
          "customCss": "/Users/007/DEV/Aptos/Aptos-document/locale/Aptos-operating-handbook/apps/docusaurus/src/css/custom.css"
        },
        "gtag": {
